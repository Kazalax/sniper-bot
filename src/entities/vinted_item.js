...
function validateId(value) {
  ...
  class VintedPhoto {
    constructor(photo) {
      ...
      // Zkracena odpoved katalogu nema full_size_url, nese jen url a nahledy.
  ...
  class VintedUser {
    constructor(userData) {
        ...
        // Zemi prodejce dnesni Vinted neposila ani v katalogu, ani na strance inzeratu.
  ...
  class VintedItem {
    constructor(itemData) {
      ...
      // Dnesni katalog vraci size_title a brand_title misto size a brand;
      // stara pole zustavaji jako zaloha pro pripad, ze API tvar zase zmeni.
      ...
      // Cena dnes chodi jako objekt { amount, currency_code }, drive jako dve pole.
      ...
      // Katalog vraci pole photos, u nekterych polozek jen jedinou fotku v poli photo.
