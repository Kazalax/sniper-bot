...
// Preklad parametru z Vinted URL kanalu na parametry katalogoveho API.
// Klic je nazev parametru v URL, hodnota nazev parametru v API.
 ...
 * Filtrovani dela server, protoze zkracena odpoved katalogu uz neobsahuje
 * catalog_id, brand_id ani dalsi pole, podle kterych se drive filtrovalo lokalne.
 ...
 * Kanal bez jedineho filtru by sledoval cely Vinted, coz zahlti jak kanal, tak API.
 ...
 *
 * Kategorie, znacka, velikost, stav a cena se uz neoveruji lokalne - o ty se stara
 * server pri dotazu. Zemi prodejce dnesni Vinted neposila ani v katalogu, ani na
 * strance inzeratu, takze parametr countries_codes zustava kvuli zpetne kompatibilite
 * volajicich, ale nefiltruje.
 *
